...
namespace BillingSoftware.Controllers
{
    ...
    public class SupplierPaymentController : ControllerBase
    {
        ...
        public SupplierPaymentController(IConfiguration configuration, IOptions<DBModel> appSettings)
        {
        ...
        [HttpGet]
        public List<SupplierPaymentNestedModel> get_supplier_Payment_details(int supplierid)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("get_supplier_Payment_details", con);
        ...
        [HttpPost]
        [ActionName("Insert_supplier_payment")]
        public ResponseModel Insert_supplier_payment(SupplierPaymentModel newMat)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Insert_supplier_payment", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (objmodel.status == "Saved successfully")
                    {
                        ...
                        {                           
                            ...
                            {
                                SqlCommand cmd1 = new SqlCommand("Insert_supplier_payment_nested", con11);
