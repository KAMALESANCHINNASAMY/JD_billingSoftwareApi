...
namespace BillingSoftware.Controllers
{
    ...
    [ApiController]
    public class ThirdPartyPurchaseNongstDebitController : ControllerBase
    {
        ...
        public ThirdPartyPurchaseNongstDebitController(IConfiguration configuration, IOptions<DBModel> appSettings)
        {
        ...
        [HttpGet]
        public List<ThirdPartyPurchaseModel> get_NonGstpurchasebythirdpartyid(int third_partyid, int companyid)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("get_NonGstpurchasebythirdpartyid", con);
        ...
        [HttpGet]
        public List<SalesBillingModel> Get_Maxid_third_partyPurchaseNongst_debit(int companyid)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_Maxid_third_partyPurchaseNongst_debit", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
                    con.Open();
                    adapter = new SqlDataAdapter(cmd);
        ...
        [HttpGet]
        public List<thirdParty_PurchaseNongst_Debitnested_Model> get_sales_billingNongst_returnDebit_nested(int thirdPartyDebitid)
        {
            DataTable dtData = null;
            List<thirdParty_PurchaseNongst_Debitnested_Model> mItems = new List<thirdParty_PurchaseNongst_Debitnested_Model>();
            SqlDataAdapter adapter = null;
            string jsonData = string.Empty;
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("get_third_partyPurchaseNongst_debit_nested", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        mItems = Helper.ConvertToList<thirdParty_PurchaseNongst_Debitnested_Model>(dtData);
                    }
                }
            }
            catch (Exception ex)
        ...
        [HttpGet]
        public List<ThirdPartyPurchaseGstDebitModel> Get_third_partyPurchaseNongst_debit(int companyid, string return_date)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_third_partyPurchaseNongst_debit", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpGet]
        public List<StockTableModel> Get_third_party_purchase_nestedBy_ref_code(int companyid, string ref_code)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_third_party_purchase_nestedBy_ref_code", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpGet]
        public List<StockTableModel> Get_third_party_purchase_nestedBy_si_code(int companyid, string si_code)
        {
            DataTable dtData = null;
            List<StockTableModel> mItems = new List<StockTableModel>();
            SqlDataAdapter adapter = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_third_party_purchase_nestedBy_si_code", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpPost]
        [ActionName("Insert_third_partyPurchaseNongst_debit")]
        public ResponseModel Insert_third_partyPurchaseNongst_debit(ThirdPartyPurchaseGstDebitModel newMat)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Update_third_partyPurchaseNongst_debit", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        {
                            foreach (var assign in newMat.thirdPartyNonGst_Debit_nested)
                            {
                                using (SqlConnection con11 = new SqlConnection(Conn))
                                {
                                    if (assign.thirdPartyDebit_n_id > 0)
                                    {
                                        SqlCommand cmd1 = new SqlCommand("update_third_partyPurchaseNongst_debit_nested", con11);
                                    ...
                                    {
                                        SqlCommand cmd1 = new SqlCommand("Insert_third_partyPurchaseNongst_debit_nested", con11);
                                        cmd1.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Insert_third_partyPurchaseNongst_debit", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@purchaseid", newMat.purchaseid);
                        cmd.Parameters.AddWithValue("@third_partyid", newMat.third_partyid);
                        cmd.Parameters.AddWithValue("@purchase_date", newMat.purchase_date);
