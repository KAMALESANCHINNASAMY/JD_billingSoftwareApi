...
namespace BillingSoftware.Controllers
{
    ...
    [ApiController]
    public class ThirdPartyGstPurchaseController : ControllerBase
    {
        ...
        public ThirdPartyGstPurchaseController(IConfiguration configuration, IOptions<DBModel> appSettings)
        {
        ...
        [HttpGet]
        public List<ThirdPartyPurchaseModel> get_Maxid_third_party_gst_purchase(int companyid)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("get_Maxid_third_party_gst_purchase", con);
        ...
        [HttpGet]
        public List<ThirdPartyPurchaseModel> get_third_party_gst_purchase(int companyid, string date)
        {
            DataTable dtData = null;
            List<ThirdPartyPurchaseModel> mItems = new List<ThirdPartyPurchaseModel>();
            SqlDataAdapter adapter = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("get_third_party_gst_purchase", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpGet]
        public List<ThirdPartyPurchaseNestedModel> get_third_party_gst_purchase_nested(int purchaseid)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("get_third_party_gst_purchase_nested", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpPost]
        [ActionName("Insert_third_party_gst_purchase")]
        public ResponseModel Insert_third_party_gst_purchase(ThirdPartyPurchaseModel newMat)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Update_third_party_gst_purchase", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        if (objmodel.status == "Saved successfully")
                        {
                            foreach (var assign in newMat.thirdparty_nested)
                            {
                                using (SqlConnection con11 = new SqlConnection(Conn))
                                {
                                    ...
                                    {
                                        SqlCommand cmd1 = new SqlCommand("Update_third_party_gst_purchase_nested", con11);
                                    ...
                                    {
                                        SqlCommand cmd1 = new SqlCommand("Insert_third_party_gst_purchase_nested", con11);
                                        cmd1.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Insert_third_party_gst_purchase", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@third_partyid", newMat.third_partyid);
                        cmd.Parameters.AddWithValue("@date", newMat.date);
                        cmd.Parameters.AddWithValue("@invoice_no", newMat.invoice_no);
        ...
        [HttpGet]
        public List<StockTableModel> get_thirdPartygst_Purchase_report_bill(int purchaseid)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("get_thirdPartygst_Purchase_report_bill", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@purchaseid", purchaseid);
                    con.Open();
                    adapter = new SqlDataAdapter(cmd);
        ...
        [HttpDelete]
        [ActionName("delete_third_party_gst_purchase")]
        public ResponseModel delete_third_party_gst_purchase(int purchaseid)
        {
            ResponseModel objmodel = new ResponseModel();
            string errorDesc = string.Empty;
            string errorCode = string.Empty;
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("delete_third_party_gst_purchase", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@purchaseid", purchaseid);
                    cmd.Parameters.Add(outErrorCode);
                    cmd.Parameters.Add(outErrorDesc);
