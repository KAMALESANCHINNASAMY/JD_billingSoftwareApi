...
namespace BillingSoftware.Controllers
{
    ...
    [ApiController]
    public class SalesBillReturnNonGSTDebitController : ControllerBase
    {
        ...
        public SalesBillReturnNonGSTDebitController(IConfiguration configuration, IOptions<DBModel> appSettings)
        {
        ...
        [HttpGet]
        public List<SalesBillingModel> get_salesbilling_Nongst_bycustomerid(int customerid, int companyid)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("get_salesbilling_Nongst_bycustomerid", con);
        ...
        [HttpGet]
        public List<SalesBillingModel> Get_Maxid_return_sales_billingNongst_returnDebit(int companyid)
        {
            DataTable dtData = null;
            List<SalesBillingModel> mItems = new List<SalesBillingModel>();
            SqlDataAdapter adapter = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_Maxid_return_sales_billingNongst_returnDebit", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
                    con.Open();
                    adapter = new SqlDataAdapter(cmd);
        ...
        [HttpGet]
        public List<sales_billReturn_Debitnested_Model> get_sales_billingNongst_returnDebit_nested(int returndebit_id)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("get_sales_billingNongst_returnDebit_nested", con);
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        [HttpGet]
        public List<SalesBillingReturnDebitModel> Get_sales_billingNongst_returnDebit(int companyid, string return_date)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_sales_billingNongst_returnDebit", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpGet]
        public List<StockTableModel> Get_salesBillingNongst_sbnestedBy_ref_code(int companyid, string ref_code)
        {
            DataTable dtData = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_salesBillingNongst_sbnestedBy_ref_code", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpGet]
        public List<StockTableModel> Get_salesBillingNongst_sbnestedBy__si_code(int companyid, string si_code)
        {
            DataTable dtData = null;
            List<StockTableModel> mItems = new List<StockTableModel>();
            SqlDataAdapter adapter = null;
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    SqlCommand cmd = new SqlCommand("Get_salesBillingNongst_sbnestedBy__si_code", con);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@companyid", companyid);
        ...
        [HttpPost]
        [ActionName("Insert_sales_billingNongst_returnDebit")]
        public ResponseModel Insert_sales_billingNongst_returnDebit(SalesBillingReturnDebitModel newMat)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(Conn))
                {
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Update_sales_billingNongst_returnDebit", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        if (objmodel.status == "Saved successfully")
                        {
                            foreach (var assign in newMat.sales_billReturnDebit_nested)
                            {
                                using (SqlConnection con11 = new SqlConnection(Conn))
                                {
                                    ...
                                    {
                                        SqlCommand cmd1 = new SqlCommand("update_sales_billingNongst_returnDebit_nested", con11);
                                    ...
                                    {
                                        SqlCommand cmd1 = new SqlCommand("Insert_sales_billingNongst_returnDebit_nested", con11);
                                        cmd1.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        SqlCommand cmd = new SqlCommand("Insert_sales_billingNongst_returnDebit", con);
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@entryid", newMat.entryid);
                        cmd.Parameters.AddWithValue("@customerid", newMat.customerid);
                        cmd.Parameters.AddWithValue("@bill_date", newMat.bill_date);
